  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex flex-col items-center justify-center px-4 sm:px-6 py-12">
      ...
      <div className="relative z-10 w-full max-w-md animate-scale-in">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="h-12 rounded-xl bg-white border-purple-100 focus-visible:ring-2 focus-visible:ring-violet-400 focus-visible:border-transparent transition-all placeholder:text-gray-400 font-medium text-black"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  onChange={handleChange}
                  className="h-12 rounded-xl bg-white border-purple-100 focus-visible:ring-2 focus-visible:ring-violet-400 focus-visible:border-transparent transition-all pr-12 font-medium text-black"
                />
                <button
                  type="button"
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={handleChange}
                className="h-12 rounded-xl bg-white border-purple-100 focus-visible:ring-2 focus-visible:ring-violet-400 focus-visible:border-transparent transition-all font-medium text-black"
              />
            </div>
        ...
        <p className="mt-8 text-center text-sm font-medium text-gray-300 bg-white/40 py-3 px-6 rounded-2xl backdrop-blur-sm border border-white/50 shadow-sm mx-auto max-w-[fit-content]">
